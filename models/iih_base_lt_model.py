...
class IIHBaseLTModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        parser.set_defaults(norm='instance', netG='base_lt', dataset_mode='ihd')
        if is_train:
    ...
    def forward(self):
        ...
        self.harmonized, self.reflectance, self.illumination = self.netG(self.inputs, self.mask, self.mask_r)
        if not self.isTrain:
